...
urlpatterns = [
    ...
    path("promocao/<slug:slug>/", views.pedido_promocao, name="pedido_promocao"),
    path('promocao/excluir/<int:id>/', views.excluir_promocao, name='excluir_promocao'),
    path('meus-pedidos/', views.clientes_pedidos, name='meus_pedidos'),
    ...
    path('cadastro/bebidas/', views.cadastro_bebidas, name='cadastrobebidas'),
    ...
    path('cadastrodiversos/', views.cadastro_produtos_diversos, name='cadastrodiversos'),
