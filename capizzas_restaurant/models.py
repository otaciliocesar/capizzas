...
class Cliente(models.Model):
    ...
    telefone = models.CharField(max_length=20)  # NOVO
    endereco_entrega = models.CharField(max_length=200)
    numero = models.CharField(max_length=15)
    complemento = models.CharField(max_length=100, blank=True, null=True)  # NOVO
    ...
    estado = models.CharField(max_length=2, blank=True, null=True)         # NOVO (UF)
...
class Compra(models.Model):
    ...
    codigo_pagamento = models.CharField(max_length=60, blank=True, null=True)
    status_pagamento = models.CharField(max_length=30, default='Aguardando')
